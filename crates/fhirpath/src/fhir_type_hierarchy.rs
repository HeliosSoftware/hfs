...
mod tests {
    ...
    fn test_resource_hierarchy() {
        ...
        println!(
            "Is Patient a resource type: {}",
            is_fhir_resource_type("Patient")
        );
        println!(
            "Is PATIENT a resource type: {}",
            is_fhir_resource_type("PATIENT")
        ...
        println!(
            "Is PATIENT derived from resource: {}",
            is_patient_derived_from_resource
        );
        assert!(
            is_patient_derived_from_resource,
            "PATIENT should be derived from resource"
        );
