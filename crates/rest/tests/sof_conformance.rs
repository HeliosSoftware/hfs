//! SQL-on-FHIR v2 official conformance test suite.
//!
//! Runs every test case in `tests/conformance/sof_v2/*.json` against the
//! in-process runner and reports all failures at the end.  A test case is
//! considered passing if:
//!
...
mod sof_conformance_tests {
    ...
    fn load_fixtures() -> Vec<Fixture> {
        let dir = std::path::Path::new("tests/conformance/sof_v2");
        assert!(
            dir.exists(),
    ...
    /// Loose equality: null ≈ missing, numbers compared as f64.
    ...
    #[tokio::test]
    async fn test_sof_v2_conformance_inprocess() {
