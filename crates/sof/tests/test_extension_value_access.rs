...
fn test_extension_value_access_patterns() {
    ...
    let test_cases = vec![
        ...
        ("extension_func", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex')"),
        
        // Test 2: Extension function + value access
        ("extension_value", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex').value"),
        
        // Test 3: Extension function + valueCode access (what should work)
        ("extension_valuecode", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex').valueCode"),
        
        // Test 4: Extension function + value + ofType
        ("extension_value_oftype", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex').value.ofType(code)"),
        
        // Test 5: Full path from failing test
        ("full_path", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex').value.ofType(code).first()"),
        
        // Test 6: Alternative using valueCode
        ("valuecode_direct", "extension('http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex').valueCode"),
    ];
