...
mod postgres_integration {
    ...
    /// The tenant-scoped provider-submission store (#772): whole-document
    /// CRUD under optimistic versioning, with listings isolated per tenant.
    #[tokio::test]
    async fn postgres_integration_provider_submissions_crud_and_tenant_scope() {
