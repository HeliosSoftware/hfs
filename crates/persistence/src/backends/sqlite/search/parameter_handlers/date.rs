...
/// single-bind SQL above predates it and already agrees with it (the tests
/// hold the two against each other), with one documented exception. A fraction is always
