...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let view_definition: fhir::r4::ViewDefinition = serde_json::from_value(view_definition_json)?;
    ...
    let result_rows: Vec<serde_json::Value> = serde_json::from_str(&result_str)?;
