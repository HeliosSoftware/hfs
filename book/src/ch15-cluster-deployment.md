...
| `pg-notify` | Cluster delivery over the PostgreSQL primary: shared counters/status/outbox tables (migration v18) plus a LISTEN/NOTIFY fan-out on a dedicated connection. Non-Postgres primaries log a warning and stay per-instance |
