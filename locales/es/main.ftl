...
search-index-rebuild-failed = La última reconstrucción del índice de búsqueda dejó { $errors } recursos sin indexar. Las búsquedas no los encuentran hasta que una reconstrucción termine bien; GET $reindex-status/{ $job } indica cuáles.
